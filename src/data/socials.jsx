// Single source of truth for the brand's social links.
// Used by SideBar, Footer and Team so every social icon site-wide stays in sync.

export const WHATSAPP_NUMBER = '201203439058' // +20 120 343 9058
...
export const TikTok = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.32 6.32 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34l-.01-8.38a8.16 8.16 0 0 0 4.77 1.52V5a4.85 4.85 0 0 1-1-.31z" />
  </svg>
)
